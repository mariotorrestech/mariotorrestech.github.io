...
!!! note "Overview"
    ...
    *Domain 7 is where the rubber meets the road and focuses on integrating security within organizational operations.*

    Often, this integration is in the form of processes that are put in place and configured to ensure that systems remain secure. Security operations are the day-to-day activities that the security function performs to support the entire organization in achieving its goals and objectives.
